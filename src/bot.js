...
client.on('message', async msg => {
    ...
    if (msg.content.startsWith("!") && msg.author.bot === false){
      ...
      if(isDj(msg) || isAuthor(msg)){
        ...
        if (msg.content.includes('!play') && validateURL(msg.content.toLowerCase())) {
          voice.Play(msg);
        }
        else if (msg.content.includes('!stream') && validateURL(msg.content.toLowerCase())) {
          voice.Stream(msg);
        }
        ...
        else if (msg.content.includes("!moveTo") || msg.content.includes("!move") ){
